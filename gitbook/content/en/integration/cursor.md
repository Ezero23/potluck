...
Integrate Potluck with Cursor IDE to route your AI requests through Potluck's intelligent routing system.

## Prerequisites

- Cursor IDE installed
- Cursor Pro account (required for custom API endpoints)
- Potluck cloud endpoint configured
- API key from Potluck dashboard

## ⚠️ Important Notes

> **Cloud Endpoint Required**: Cursor routes requests through its own server and does not support localhost endpoints. You must use the Potluck cloud endpoint: `http://localhost:20129`
...
Set the base URL to Potluck cloud endpoint:
...
3. Enter the model name from your Potluck configuration (e.g., `gpt-4`, `claude-opus-4-5`, etc.)
4. Click **Add**
...
3. Start using Potluck with Cursor!
...
3. Start chatting with AI through Potluck
...
2. Press Cmd/Ctrl + K
3. Enter your prompt
4. Cursor will use Potluck to generate code
...
4. Get AI-powered explanations through Potluck
...
1. Verify you are using the cloud endpoint: `http://localhost:20129`
2. Check your internet connection
3. Ensure Potluck cloud service is operational
4. Try disabling VPN or proxy if enabled

### Localhost Not Working

> **Remember**: Cursor does not support localhost endpoints. You must use the cloud endpoint `http://localhost:20129`. If you need to use a local Potluck instance, consider using a tunneling service like ngrok to expose your local endpoint.

## Cloud Endpoint Setup

If you're running Potluck locally and want to use it with Cursor:

1. Enable cloud endpoint in Potluck settings
2. Configure your cloud endpoint URL in Potluck dashboard
3. Use the cloud URL in Cursor settings
4. Ensure your local Potluck instance is accessible from the internet

## Best Practices

1. **Use Model Aliases**: Create short aliases for frequently used models in Potluck
