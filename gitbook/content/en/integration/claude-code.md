...
Integrate Potluck with Claude Code CLI to route your Anthropic API requests through Potluck's intelligent routing system.
...
Claude Code supports the following model aliases that map to Potluck models:
