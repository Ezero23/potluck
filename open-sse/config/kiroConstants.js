 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what potluck needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a potluck
...
/**
 * Detect whether a model id refers to a potluck synthetic agentic variant.
...
/**
 * Detect whether a model id is a potluck synthetic thinking variant
...
/**
 * Resolve a potluck model id to the real upstream Kiro model id, plus flags
