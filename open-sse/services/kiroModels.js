 ...
 * API. They are potluck fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic potluck variant set for a single upstream Kiro model.
 *
 ...
 * into potluck variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
