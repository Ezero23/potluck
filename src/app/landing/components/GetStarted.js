        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Install Potluck, configure your providers via web dashboard, and start routing AI requests.
            </p>
            ...
            <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-[#1f1f1f] shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                <div 
                  ...
                  onClick={() => handleCopy("npx potluck")}
                >
                  <span className="text-green-400">$</span>
                  <span className="text-white">npx potluck</span>
                ...
                <div className="text-gray-400 text-xs">
                  ...
                  <span className="text-gray-500">  macOS/Linux:</span> ~/.potluck/db/data.sqlite<br/>
                  <span className="text-gray-500">  Windows:</span> %APPDATA%/potluck/db/data.sqlite
                </div>
              </div>
            </div>
          </div>
