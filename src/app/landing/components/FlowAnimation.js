...
export default function FlowAnimation() {
  ...
  return (
    <div className="mt-16 w-full max-w-4xl relative h-[360px] hidden md:flex items-center justify-center animate-[float_6s_ease-in-out_infinite]">
      {/* Potluck Hub - Center */}
      <div className="relative z-20 w-32 h-32 rounded-full bg-[#0a0a0a] border-2 border-[#22d3ee] shadow-[0_0_40px_rgba(34,211,238,0.3)] flex flex-col items-center justify-center gap-1 group cursor-pointer hover:scale-105 transition-transform duration-500">
      ...
      <div className="absolute left-0 top-1/2 -translate-y-1/2 flex flex-col gap-7">
        {CLI_TOOLS.map((tool) => (
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-[#0a0a0a] border border-[#1f1f1f] flex items-center justify-center overflow-hidden p-2 hover:border-[#22d3ee]/50 transition-all hover:scale-105">
              <ProviderIcon
                src={tool.image}
                alt={tool.name}
                size={48}
      ...
      {/* SVG Lines from Potluck to Providers */}
      <svg
      ...
      {/* Mobile fallback */}
      <div className="md:hidden mt-8 w-full p-4 rounded-lg bg-[#0a0a0a] border border-[#1f1f1f]">
