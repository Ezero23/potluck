...
export default function LandingPage() {
  ...
  return (
    <div className="relative text-white font-sans overflow-x-hidden antialiased selection:bg-[#22d3ee] selection:text-white">
      {/* Animated Background */}
        ...
        <section className="py-32 px-6 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
              Join developers who are streamlining their AI integrations with Potluck. Open source and free to start.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button 
                onClick={() => router.push("/dashboard")}
                className="w-full sm:w-auto h-14 px-10 rounded-lg bg-[#22d3ee] hover:bg-[#06b6d4] text-[#000000] text-lg font-bold transition-all shadow-[0_0_20px_rgba(34,211,238,0.5)]"
              >
                Start Free
              </button>
              <button 
