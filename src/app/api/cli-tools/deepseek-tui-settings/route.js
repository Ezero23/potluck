...
// Build TOML config for Potluck (openai provider mode)
const buildPotluckConfig = (baseUrl, apiKey, model) => {
...
// Detect Potluck by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildPotluckConfig(baseUrl, apiKey || "sk_potluck", model);
