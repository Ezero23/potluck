...
import { removeLegacyMitmRouterDefault } from "./migrations/002-remove-legacy-mitm-router-default.js";
...
function importLegacyMain(adapter, data) {
  ...
  if (data.settings) {
    const settings = removeLegacyMitmRouterDefault(data.settings);
