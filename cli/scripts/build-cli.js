...
console.log("📦 Building Potluck CLI package with Next.js...\n");
...
// e.g. .next-cli-build/standalone/potluck/server.js
...
// Strip better-sqlite3 (native) — it lives in ~/.potluck/runtime to avoid
...
if (fs.existsSync(betterDir)) {
  ...
  console.log("✅ Stripped better-sqlite3 (lives in ~/.potluck/runtime)");
}
console.log("");
