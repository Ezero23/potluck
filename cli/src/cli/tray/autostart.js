...
const APP_NAME = "potluck";
const APP_LABEL = "com.potluck.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when potluck is currently
 ...
 * SIGTERM to the running process. When the running potluck cli.js was itself
...
<dict>
    ...
    <string>/tmp/potluck.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/potluck.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `potluck.cmd` lookup that depended on the npm prefix path.
